...
- **Dynamic Backgrounds:** 3D city miniatures that change with weather.
- **Real-time Data:** Powered by OpenMeteo API.
- **Global Search:** Search by city name or use GPS.

## 🛡 Privacy & GDPR
Compliant with GDPR and Google DSA regulations. Users can manage their ad consent or delete their data directly from the settings.
